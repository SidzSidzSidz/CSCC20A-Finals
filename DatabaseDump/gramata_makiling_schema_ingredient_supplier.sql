...
CREATE TABLE `ingredient_supplier` (
  ...
  `sid` int(11) NOT NULL,
  PRIMARY KEY (`inum`,`sid`),
  KEY `sid_idx` (`sid`),
  CONSTRAINT `inum` FOREIGN KEY (`inum`) REFERENCES `ingredient` (`inum`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `sid_fkone` FOREIGN KEY (`sid`) REFERENCES `supplier` (`sid`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `ingredient_supplier` (`inum`, `sid`) VALUES (1,3),(2,3);
